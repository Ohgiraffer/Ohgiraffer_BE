...
public class Attendance {
    ...
    public static Attendance create(Long userId, LocalDate attendanceDate, AttendanceStatus status,
                                    LocalTime checkInTime, LocalTime checkOutTime, String externalRefId) {
        return new Attendance(null, userId, attendanceDate, status, checkInTime, checkOutTime, externalRefId);
    }

    // DB에서 복원할 때 사용
    public static Attendance reconstitute(Long id, Long userId, LocalDate attendanceDate, AttendanceStatus status,
                                          LocalTime checkInTime, LocalTime checkOutTime, String externalRefId) {
        return new Attendance(id, userId, attendanceDate, status, checkInTime, checkOutTime, externalRefId);
    }
