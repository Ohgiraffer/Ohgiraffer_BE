...
public class ChatController {
    ...
    public ResponseEntity<ChatMessageResponse> sendMessage(
        ...
        Long senderId = null; // TODO: 인증 붙으면 실제 로그인 유저 id로 교체

        SendbirdMessageResult result = chatMessageCommandUseCase.sendMessage(
                new SendMessageCommand(channelId, senderId, request.content(),
    ...
    public ResponseEntity<ChatMessageResponse> reply(
        ...
        SendbirdMessageResult result = chatReplyCommandUseCase.reply(
                new ReplyToMessageCommand(request.channelId(), messageId, senderId,
    ...
    public ResponseEntity<Void> updateMessage(
        ...
        Long requesterId = null; // TODO: 인증 붙으면 실제 로그인 유저 id로 교체

        chatMessageCommandUseCase.updateMessage(
                new UpdateMessageCommand(request.channelId(), messageId, requesterId, request.content())
        );
    ...
    public ResponseEntity<Void> deleteMessage(
        ...
        chatMessageCommandUseCase.deleteMessage(
                new DeleteMessageCommand(channelId, messageId, requesterId)
        );
        return ResponseEntity.noContent().build();
    }
